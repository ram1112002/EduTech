...
class Computer_2nd extends StatefulWidget{
  _Computer_2ndState createState() => _Computer_2ndState();

}
class _Computer_2ndState extends State<Computer_2nd> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of Computer for a student of 2nd Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("Computer_2nd").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return VideoConferencePage(
                            ...
                            Name: name,conferenceID: "Computer_2nd"
                        );}));},
                  child: Padding(
