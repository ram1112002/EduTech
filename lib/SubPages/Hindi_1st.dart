...
class Hindi_1st extends StatefulWidget{
  _Hindi_1stState createState() => _Hindi_1stState();

}
class _Hindi_1stState extends State<Hindi_1st> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of Hindi for a student of 1st Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("Hindi_1st").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return VideoConferencePage(
                            ...
                            Name: name,conferenceID: "Hindi_1st"
                        );}));},
                  child: Padding(
