...
class SST_1st extends StatefulWidget{
  _SST_1stState createState() => _SST_1stState();

}
class _SST_1stState extends State<SST_1st> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of SST for a student of 1st Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("SST_1st").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return VideoConferencePage(
                            ...
                            Name: name,conferenceID: "SST_1st"
                        );}));},
                  child: Padding(
