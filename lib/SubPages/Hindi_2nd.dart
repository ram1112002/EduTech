...
class Hindi_2nd extends StatefulWidget{
  _Hindi_2ndState createState() => _Hindi_2ndState();

}
class _Hindi_2ndState extends State<Hindi_2nd> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of Hindi for a student of 2nd Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("Hindi_2nd").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return VideoConferencePage(
                            ...
                            Name: name,conferenceID: "Hindi_2nd"
                        );}));},
                  child: Padding(
