...
Future main() async {
  ...
  Stripe.publishableKey = "pk_test_51MhnKuSEVMo4lT9kfLmDOpkamrMueSGhH97zK5Sx4naCvdCRbkfJMa4XbSR01s0oij8lTokPuU9b9tsdkwTSW5mI00WMxTKA8L";
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) =>MaterialApp(
    ...
    routes: {
      MyRoutes.Math_1st : (context) => Math_1st(),
      MyRoutes.Science_1st : (context) => Science_1st(),
    },
    );
  }
