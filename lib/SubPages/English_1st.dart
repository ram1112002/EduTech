...
class English_1st extends StatefulWidget{
  _English_1stState createState() => _English_1stState();

}
class _English_1stState extends State<English_1st> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of English for a student of 1st Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("English_1st").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return VideoConferencePage(
                            ...
                            Name: name,conferenceID: "English_1st"
                        );}));},
                  child: Padding(
