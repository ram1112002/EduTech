...
class GK_1st extends StatefulWidget{
  _GK_1stState createState() => _GK_1stState();

}
class _GK_1stState extends State<GK_1st> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of GK for a student of 1st Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("GK_1st").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
