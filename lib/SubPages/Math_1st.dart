...
class Math_1st extends StatefulWidget{
  _Math_1stState createState() => _Math_1stState();

}
class _Math_1stState extends State<Math_1st> {
    ...
    return Padding(
          ...
          children: [
            Padding(
             ...
             Padding(
               ...
               child: Text("You have successfully enrolled into a great course of Maths for a student of 1st Class",style: TextStyle(
                 fontWeight: FontWeight.w200,
                 fontSize: 20,
               ),),
             ),
        ...
        children: <Widget>[
          ...
          SizedBox(width: 20),
                  Expanded(
                  child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("Math_1st").doc(email).get();
                name = res.get("Name");
              Navigator.push(
              context,
              ...
              Name: name,conferenceID: "Math_1st"
              );}));},
                  child: Padding(
