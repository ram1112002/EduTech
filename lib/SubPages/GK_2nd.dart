...
class GK_2nd extends StatefulWidget{
  _GK_2ndState createState() => _GK_2ndState();

}
class _GK_2ndState extends State<GK_2nd> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("You have successfully enrolled into a great course of GK for a student of 2nd Class",style: TextStyle(
              fontWeight: FontWeight.w200,
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: InkWell(
                  onTap: ()async{var res = await FirebaseFirestore.instance.collection("GK_2nd").doc(email).get();
                  name = res.get("Name");
                  Navigator.push(
                      context,
